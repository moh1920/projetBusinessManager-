...
import {RegisterEntrepriseSetpperComponent} from "./register-entreprise-setpper/register-entreprise-setpper.component";
...
const routes: Routes = [
...

  {
    ...
    children: [
      ...
      {
        path: 'stepperCompany',
        component: RegisterEntrepriseSetpperComponent,
      },
    ],
  },
];
